...
def treina_agente(nome_algoritmo, n_iter_agente, n_iter_checkpoints, Tinf, only_iqb, total_timesteps):
    ...
    if nome_algoritmo == "proximal_policy_optimization":
        ...
        model_path = os.path.join(path_root, f"gpi_ls_agent_Tinf{Tinf}.zip" + only_iqb_flag)
...
def avalia_agente(nome_algoritmo, Tinf, only_iqb):
    ...
    if nome_algoritmo != "gpi-ls":
        ...
        checkpoint_path = path_root + "gpi_ls_agent_Tinf" + Tinf_var +".zip" + only_iqb_flag +"/gpi_ls_Tinf" + Tinf_var + ".tar"
...
if __name__ == "__main__":
    ...
    if args["acao"] == "treina":
        treina_agente(nome_algoritmo, n_iter_agente, n_iter_checkpoints, Tinf, args["only_iqb"] == "True", args["total_timesteps"])
    if args["acao"] == "avalia":
