...
print("The 'cdd' module is being imported from:")
print(os.path.dirname(cdd.__file__))

# You can also try to create a matrix to see if the API is different
try:
    mat = cdd.Matrix([[1, 2], [3, 4]], number_type="float")
    print("\nSuccessfully created a matrix. The API is likely compatible.")
