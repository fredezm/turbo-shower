...
def avalia_agente(nome_algoritmo, Tinf):
    ...
    ax[2].legend()
    plt.savefig(path_imagens + "resultado5_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
    ...
    ax[1, 1].legend()
    plt.savefig(path_imagens + "resultado6_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
    ...
    ax[2].legend()
    plt.savefig(path_imagens + "resultado7_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
    ...
    ax.legend()
    plt.savefig(path_imagens + "resultado8_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
