...
def avalia_agente(nome_algoritmo, Tinf):
    ...
    Tinf_var = str(Tinf)
    path_root_models = "/backup_resultados/models/models_Tinf" + Tinf_var + "/"
    path_root = os.getcwd() + path_root_models
    ...
    path_imagens = os.getcwd() + "/imagens/imagens_Tinf" + Tinf_var + "/"
    ...
    ax[2].legend()
    plt.savefig(path_imagens + "resultado11_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
    ...
    ax[1, 1].legend()
    plt.savefig(path_imagens + "resultado21_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
    ...
    ax[2].legend()
    plt.savefig(path_imagens + "resultado31_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
    ...
    ax.legend()
    plt.savefig(path_imagens + "resultado41_" + nome_algoritmo + "_Tinf" + Tinf_var + ".png", dpi=200)
